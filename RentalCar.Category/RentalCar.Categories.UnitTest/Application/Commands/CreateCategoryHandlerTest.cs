...
namespace RentalCar.Categories.UnitTest.Application.Commands
{
    ...
    {
        [Fact]
        public async void CreateCategory_Executed_return_InputCategoryResponse()
        {
            // Arrange
            ...
            var createCategoryHandler = new CreateCategoryHandler(_categoryRepositoryMock.Object, _loggerServiceMock.Object);
