...
namespace RentalCar.Categories.UnitTest.Application.Commands
{
    ...
    {
        [Fact]
        public async void DeleteCategory_Executed_Return_InputCategoryResponse()
        {
            // Arrange
            ...
            var deleteCategoryHandler = new DeleteCategoryHandler(_categoryRepositoryMock.Object, _loggerServiceMock.Object);
