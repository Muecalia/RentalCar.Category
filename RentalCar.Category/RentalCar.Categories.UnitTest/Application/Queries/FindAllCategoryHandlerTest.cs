...
namespace RentalCar.Categories.UnitTest.Application.Queries
{
    ...
    {
        [Fact]
        public async void FindAllCategories_Executed_Return_List_FindCategoryResponse()
        {
            // Arrange
            ...
            var findAllCategoriesHandler = new FindAllCategoriesHandler(_categoryRepositoryMock.Object, _loggerServiceMock.Object);
