...
namespace RentalCar.Categories.UnitTest.Application.Queries
{
    ...
    {
        [Fact]
        public async void FindCategoryById_Executed_Return_FindCategoryResponse()
        {
            // Arrange
            ...
            var findCategoryByIdHandler = new FindCategoryByIdHandler(_categoryRepositoryMock.Object, _loggerServiceMock.Object);
